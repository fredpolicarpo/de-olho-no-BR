...
candidatos_eleicoes_federais = fluidRow(
  box(
    title = "Quantidade de candidatos - Federal",
    solidHeader = TRUE,
    collapsible = TRUE,
    width = 12,
    checkboxGroupInput(
      "selectCargosFederativos",
      "",
      choices = c(
    ...
    plotlyOutput("grafico_anos_eleicoes_federativas", height = 300)
  )
)

candidatos_eleicoes_locais = fluidRow(
  box(
    title = "Quantidade de candidatos - Local" ,
    solidHeader = TRUE,
    collapsible = TRUE,
    width = 12,
    checkboxGroupInput(
      "selectCargosLocais",
      "",
      choices =  c('Prefeito' = "PREFEITO", 'Vereador' = "VEREADOR")
    ),
    plotlyOutput("grafico_anos_eleicoes_locais", height = 300)
  )
)
...
quantidade_candidatos = fluidRow(
  ...
  box(
    title = "Quantidade de candidatos - Eleiçõs Locais" ,
    solidHeader = TRUE,
    collapsible = TRUE,
    width = 6,
...
mapa_partidos_coligacoes = fluidRow(
  box(
    ...
    box(
      title = "Mapa Quantidade de partidos" ,
      solidHeader = TRUE,
      collapsible = TRUE,
      width = 6,
    ...
    box(
      title = "Mapa Quantidade de coligações" ,
      solidHeader = TRUE,
      collapsible = TRUE,
      width = 6,
...
dashLegendas = tabItem(
  ...
  tags$br(),
  #candidatos_eleicoes_federais,
  #candidatos_eleicoes_locais,
