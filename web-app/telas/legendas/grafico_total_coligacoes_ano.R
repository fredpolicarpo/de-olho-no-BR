...
dados_total_coligacoes_ano= function(con, output) {
  dados = total_coligacoes_ano(con)
  ...
  output$grafico_coligacoes_eleicoes_locais_ano = renderPlotly({plot_locais})
  ...
  output$grafico_coligacoes_eleicoes_federativas_ano = renderPlotly({plot_federativas})
}