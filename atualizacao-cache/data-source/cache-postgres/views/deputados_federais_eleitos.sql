DROP MATERIALIZED VIEW IF EXISTS deputados_federais_eleitos;
CREATE MATERIALIZED VIEW IF NOT EXISTS deputados_federais_eleitos
AS
  WITH eleitos AS (
      SELECT
        ano_eleicao,
