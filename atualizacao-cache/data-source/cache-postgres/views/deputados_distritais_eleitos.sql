DROP MATERIALIZED VIEW IF EXISTS deputados_distritais_eleitos;
CREATE MATERIALIZED VIEW IF NOT EXISTS deputados_distrais_eleitos
AS
  WITH eleitos AS (
      SELECT
        ano_eleicao,
